...
public class ResponseFactory {
    ...
    public static UpdateChatParticipantResponse createUpdateChatParticipantResponse(Boolean success, String message) {
        return UpdateChatParticipantResponse.builder()
                .success(success)
                .message(message)
                .build();
    }
